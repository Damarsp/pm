                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form action="<?= route_to('register') ?>" method="post" class='user'>
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="nik" class="form-control form-control-user" placeholder="Nik">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="telp" class="form-control form-control-user" placeholder="No Telp">
                                    </div>
